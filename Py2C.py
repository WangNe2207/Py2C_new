...
class Py2C:
    ...
    def __init__(self, model_path, type="fxp", fxp_para=(16, 5), choose_only_output=True, ide = "vs"):
    ...
    def convert2C(self):
            ...
            for i in range(len(self.config["layers"])):
                ...
                if layer.find("conv2d") >= 0 and layer.find("conv2d_input") < 0:
                    ...
                    if activation == "relu":
                        ...
                        self.act_arr = "Output_Conv[" + str(out_shape[1]) + "*" + str(out_shape[2]) + "*n+" + str(out_shape[2]) + "*x+y]=s+bias[n];"
                    ...
                    if self.config["layers"][i]['config']['padding'] == 'same':
                        padding = (((out_shape[1] - 1) * stride - in_shape[1] + kernel_shape[2])/2,((out_shape[2] - 1) * stride - in_shape[2] + kernel_shape[3])/2)
                        ...
                        source_pad_conv_cc = self.fxp_inc + "void Padding_Conv2D_" + str(self.index2D) + "(" + self.type + " input_Pad_Conv[" + str(in_shape[0] * in_shape[1] * in_shape[2]) + "], " + self.type + " output_Pad_Conv[" + str(int(in_shape_if_padding[0] * in_shape_if_padding[1] * in_shape_if_padding[2])) + "]){\n\tloop_for_3_channel_pad_" + str(self.index2D) + ":\n\tfor (int c = 0; c < " + str(in_shape_if_padding[0]) + "; c++){" + "\n\t\tloop_for_channel_pad_" + str(self.index2D) + ":\n\t\tfor (int n = 0; n < " + str(int(in_shape_if_padding[1])) + "; n++){\n\t\t\tloop_for_weight_pad_" + str(self.index2D) + ":\n\t\t\tfor (int i = 0; i < " + str(int(in_shape_if_padding[2])) + "; i++){\n\t\t\t\t"
                        if padding[0] < 1:
                            source_pad_conv_cc += "if (n >= " + str(in_shape[2]) + ") output_Pad_Conv[" + str(int(in_shape_if_padding[1])) + " * " + str(int(in_shape_if_padding[2])) + " * c + " + str(int(in_shape_if_padding[2])) + " * n + i]=0;\n\t\t\t\t else \n\t\t\t\t\tif (i >= " + str(in_shape[2]) + ") output_Pad_Conv[" + str(int(in_shape_if_padding[1])) + " * " + str(int(in_shape_if_padding[2])) + " * c + " + str(int(in_shape_if_padding[2])) + " * n + i]=0; else output_Pad_Conv[" + str(int(in_shape_if_padding[1])) + " * " + str(int(in_shape_if_padding[2])) + " * c + " + str(int(in_shape_if_padding[2])) + " * n + i] = input_Pad_Conv[" + str(in_shape[1]) + " * " + str(in_shape[2]) + " * c + " + str(in_shape[2]) + " * n + i];\n\t\t\t}\n\t\t}\n\t}\n}\n"
                        else:
                            source_pad_conv_cc += "if (n < " + str(int(0 + (padding[0]))) + " || n >= " + str(int(in_shape[2] + (padding[0]))) + ") output_Pad_Conv[" + str(int(in_shape_if_padding[1])) + " * " + str(int(in_shape_if_padding[2])) + " * c + " + str(int(in_shape_if_padding[2])) + " * n + i]=0;\n\t\t\t\t else \n\t\t\t\t\tif (i < " + str(int(0 + (padding[0]))) + " || i >= " + str(int(in_shape[2] + (padding[0]))) + ") output_Pad_Conv[" + str(int(in_shape_if_padding[1])) + " * " + str(int(in_shape_if_padding[2])) + " * c + " + str(int(in_shape_if_padding[2])) + " * n + i]=0; else output_Pad_Conv[" + str(int(in_shape_if_padding[1])) + " * " + str(int(in_shape_if_padding[2])) + " * c + " + str(int(in_shape_if_padding[2])) + " * n + i] = input_Pad_Conv[" + str(in_shape[1]) + " * " + str(in_shape[2]) + " * c + " + str(in_shape[2]) + " * (n - " + str(int(padding[1])) + ") + i - " + str(int(padding[1])) + "];\n\t\t\t}\n\t\t}\n\t}\n}\n"
                        source_pad_conv_hh = self.fxp_inc + "void Padding_Conv2D_" + str(self.index2D) + "(" + self.type + " input_Pad_Conv[" + str(in_shape[0] * in_shape[1] * in_shape[2]) + "], " + self.type + " output_Pad_Conv[" + str(in_shape[0] * int(in_shape[1] + 2*padding[0]) * int(in_shape[2] + 2*padding[1])) + "]);\n"
                        self.full_source_Conv_cc.append(source_pad_conv_cc)
                        self.full_source_Conv_hh.append(source_pad_conv_hh)
                        self.call_function += "\t" + self.type + " OutPadConv" + str(self.index2D) + "[" + str(in_shape[0] * int(in_shape[1] + 2*padding[0]) * int(in_shape[2] + 2*padding[1])) + "];\n"
                        self.full_source_CNN_cc.append(
                            ["\tPadding_Conv2D_" + str(self.index2D) + "(", "OutPadConv" + str(self.index2D), "",
                             ""])
                        self.call_function += "\t" + self.type + " " + self.config["layers"][i]['config']['name'] + "[" + str(
                            out_shape[0] * out_shape[1] * out_shape[2]) + "];\n"
                        source_Conv_cc = self.fxp_inc + "void Conv2D_" + str(
                            self.index2D) + "(" + self.type + " Input_Conv[" + str(int(in_shape_if_padding[0] * in_shape_if_padding[1] * in_shape_if_padding[2])) + "]," + self.type + " Output_Conv[" + str(
                            ...
                            kernel_shape[3]) + "*i+j])*(Input_Conv[" + str(int(in_shape_if_padding[1])) + "*" + str(int(in_shape_if_padding[2])) + "*k+" + str(int(in_shape_if_padding[2])) + "*(i+x*stride)+j+y*stride]);}\n\t\t\t\t\t}\n\t\t\t\t}\n\t\t\t\t" + self.act_arr + "\n\t\t\t}\n\t\t}\n\t}\n}\n"
                    ...
                    self.full_source_CNN_cc.append(
                        ["\tConv2D_" + str(self.index2D) + "(", self.config["layers"][i]['config']['name'], "&Weights[" + str(
                ...
                if layer.find("conv1d") >= 0 and layer.find("conv1d_input") < 0:
                    ...
                    if self.config["layers"][i]['config']['padding'] == 'same':
                        ...
                        self.full_source_Conv_cc.append(source_pad_conv_cc)
                        self.full_source_Conv_hh.append(source_pad_conv_hh)
                        self.call_function += "\t" + self.type + " OutPadConv" + str(self.index) + "[" + str(in_shape[0] * (in_shape[1] + 2 * padding)) + "];\n"
                        self.full_source_CNN_cc.append(
                    ...
                    self.full_source_Conv_cc.append(source_Conv_cc)
                    self.full_source_Conv_hh.append(source_Conv_hh)
                    self.full_source_CNN_cc.append(["\tConv1D_" + str(self.index) + "(", self.config["layers"][i]['config']['name'] , "&Weights[" + str(
                ...
                if layer.find("add") >= 0:
                    ...
                    if len(self.model.layers[i].input_shape[0]) == 4:
                        ...
                        source_add = ""
                        argument_add = ""
                        size = self.model.layers[i].input_shape[0][1] * self.model.layers[i].input_shape[0][2] * self.model.layers[i].input_shape[0][3]
                    ...
                    self.call_function += "\t" + str(self.type) + " " + self.config["layers"][i]['config']['name'] + "[" + str(size) + "];\n"
                    source_Conv_cc = "void Add_" + str(self.indexAdd) + "(" + argument_add + str(self.type) + " output[" + str(size) + "]) {" + "\n\tfor (int i = 0; i < " + str(size) + "; i++){\n\t\toutput[i] = " + source_add + ";\n\t}\n}\n"
                    source_Conv_hh = "void Add_" + str(self.indexAdd)+ "(" + argument_add + str(self.type) + " output[" + str(size) + "]);\n"
                    self.full_source_CNN_cc.append(["\tAdd_" + str(self.indexAdd) + "(", self.config["layers"][i]['config']['name']])
                    self.full_source_Conv_cc.append(source_Conv_cc)
                    self.full_source_Conv_hh.append(source_Conv_hh)
                    self.indexAdd += 1
                ...
                if layer.find("concatenate") >= 0:
                    ...
                    assert len(self.model.layers[i].input_shape[0]) <= 3, "concatenate layer has not supporting 3 dimesion input yet!!!"
                    assert self.model.layers[i].axis == -1, "concatenate layer has not supporting other axis value but -1"
                    if len(self.model.layers[i].input_shape[0]) == 3:
                        NumOfInput = len(self.model.layers[i].input_shape)
                        source = ""
                        argument = ""
                        for k in range(0, NumOfInput):
                            ...
                            source += "\tfor (int i = 0; i < " + str(size) + ";i++){\n\t\toutput[" + str(k) + " * " + str(size) + " + i] = input_" + str(k) + "[i];\n\t}\n"
                    ...
                    source_Conv_cc = self.fxp_inc + " void Concatenate_" + str(self.indexConcatenate) + "(" + argument + str(self.type) + " output[" + str(self.model.layers[i].output_shape[1] * self.model.layers[i].output_shape[2]) + "]) {\n" + source +"\n}\n"
                    source_Conv_hh = "void Concatenate_" + str(self.indexConcatenate)+ "(" + argument + str(self.type) + " output[" + str(self.model.layers[i].output_shape[1] * self.model.layers[i].output_shape[2]) + "]);\n"
                    self.full_source_CNN_cc.append(["\tConcatenate_" + str(self.indexConcatenate) + "(", self.config["layers"][i]['config']['name']])
                    self.full_source_Conv_cc.append(source_Conv_cc)
                    self.full_source_Conv_hh.append(source_Conv_hh)
                ...
                if layer.find("batch_normalization") >= 0:
                    ...
                    if (len(self.model.layers[i].input.shape) == 4):
                        ...
                        self.call_function += "\t" + str(self.type) + " " + self.config["layers"][i]['config']['name'] + "[" + str(in_shape[0] * in_shape[1] * in_shape[2]) + "];\n"
                        type_sqrt = ""
                        if self.type == "fxp":
                        ...
                        self.full_source_CNN_cc.append(["\tBatchNorm2D_" + str(self.indexBatch) + "(", self.config["layers"][i]['config']['name'] ,
                             "&Weights[" + str(self.cnt_param) + "]",
                    ...
                    if (len(self.model.layers[i].input.shape) == 2):
                        ...
                        for k in moving_variance:
                            self.Weights.append(k)
                        self.call_function += "\t" + str(self.type) + " " + self.config["layers"][i]['config']['name'] + "[" + str(in_shape) + "];\n"
                    ...
                    if (len(self.model.layers[i].input.shape) == 3):
                            ...
                            for k in moving_variance:
                                self.Weights.append(k)
                            self.call_function += "\t" + str(self.type) + " " + self.config["layers"][i]['config']['name'] + "[" + str(in_shape[0] * in_shape[1]) + "];\n"
                            ...
                            self.full_source_CNN_cc.append(["\tBatchNorm1D_" + str(self.indexBatch) + "(", self.config["layers"][i]['config']['name'],"&Weights[" + str(self.cnt_param) + "]","&Weights[" + str(self.cnt_param + len(gamma)) + "]","&Weights[" + str(self.cnt_param + len(gamma) + len(beta)) + "]","&Weights[" + str(self.cnt_param + len(gamma) + len(beta) + len(moving_mean)) + "]"])
                            self.full_source_Conv_cc.append(source_Conv_cc)
                            self.full_source_Conv_hh.append(source_Conv_hh)
                            self.indexBatch += 1
                            self.cnt_param += len(gamma) + len(beta) + len(moving_mean) + len(moving_variance)

                if layer.find("activation") >= 0 or layer.find("re_lu") >= 0:
                    found = 1
                    # 3D and 1D, FC layer
                    if len(self.model.layers[i].input.shape) == 2:
                        in_shape = self.model.layers[i].input.shape[1]
                        ...
                        source_Conv_hh = self.fxp_inc + "void Activation" + str(self.indexActi) + "(" + str(
                            self.type) + " Input_Activation[" + str(in_shape) + "], " + str(
                            self.type) + " Output_Activation[" + str(out_shape) + "]);\n"
                        self.full_source_CNN_cc.append(["\tActivation" + str(self.indexActi) + "(", self.config["layers"][i]['config']['name']])
                        self.full_source_Conv_cc.append(source_Conv_cc)
                        self.full_source_Conv_hh.append(source_Conv_hh)
                        self.indexActi += 1
                    ...
                    if len(self.model.layers[i].input.shape) == 4:
                        in_shape = (self.model.layers[i].input.shape[1],self.model.layers[i].input.shape[2],self.model.layers[i].input.shape[3])
                        out_shape = (self.model.layers[i].output.shape[1],self.model.layers[i].output.shape[2],self.model.layers[i].output.shape[3])
                        self.call_function += "\t" + str(self.type) + " " + self.config["layers"][i]['config']['name'] + "[" + str(out_shape[0]*out_shape[1]*out_shape[2]) + "];\n"
                    ...
                    if len(self.model.layers[i].input.shape) == 3:
                        in_shape = (self.model.layers[i].input.shape[1],self.model.layers[i].input.shape[2])
                        out_shape = (self.model.layers[i].output.shape[1],self.model.layers[i].output.shape[2])
                        self.call_function += "\t" + str(self.type) + " " + self.config["layers"][i]['config']['name'] + "[" + str(out_shape[0]*out_shape[1]) + "];\n"
                ...
                if layer.find("average_pooling2d") >= 0:
                    if layer.find("global_average_pooling2d") < 0:
                        found = 1
                        in_shape = (self.model.layers[i].input.shape[1], self.model.layers[i].input.shape[2],
                                    self.model.layers[i].input.shape[3])
                        out_shape = (self.model.layers[i].output.shape[1], self.model.layers[i].output.shape[2],
                        ...
                        padding = (in_shape[1] - poolSize) / strides

                        def find_smallest_pad(i, k, s):
                            p = 0
                            while True:
                                if (i - k + 2 * p) % s == 0:
                                    return p
                        ...
                        if isinstance(padding, int):
                            ...
                            source_Pool_cc = self.fxp_inc + "void average_Pool2D_" + str(self.index_P2D) + "(" + self.type + " input_AveragePooling[" + str(in_shape[0] * in_shape[1] * in_shape[2]) + "], " + self.type + " output_AveragePooling[" + str(out_shape[0] * out_shape[1] * out_shape[2]) + "]){\n\tint PoolSize = " + str(poolSize) + ";\n\tint stride = " + str(strides) + ";\n\tint index = 0;\n\tfor (int i = 0; i < " + str(out_shape[0]) + "; i++){\n\t\tindex = 0;\n\t\tfor (int z = 0; z < " + str(out_shape[1]) + "; z++){\n\t\t\tfor (int y = 0; y < " + str(out_shape[2]) + "; y++){\n\t\t\t\t" + str(self.type) + " Average = 0;\n\t\t\t\t" + str(self.type) + " Pool_value = 0;\n\t\t\t\tfor (int h = 0; h < PoolSize; h++){\n\t\t\t\t\tfor (int w = 0; w < PoolSize; w++){\n\t\t\t\t\t\tint Pool_index = " + str(in_shape[1]) + " * " + str(in_shape[2]) + " * i + " + str(in_shape[1]) + " * h + " + str(in_shape[2]) + " * stride * z + w + y * stride;\n\t\t\t\t\t\tPool_value += input_AveragePooling[Pool_index];" + "\n\t\t\t\t\t\tAverage = Pool_value / " + str(poolSize * poolSize) + ";\n\t\t\t\t\t}\n\t\t\t\t}" + "\n\t\t\t\tint outIndex = " + str(out_shape[1]) + " * " + str(out_shape[2]) + " * i + index;\n\t\t\t\toutput_AveragePooling[outIndex] = Average;\n\t\t\t\tindex++;" + "\n\t\t\t}\n\t\t}\n\t}\n}\n"
                            source_Pool_hh = self.fxp_inc + "void average_Pool2D_" + str(self.index_P2D) + "(" + self.type + " input_AveragePooling[" + str(in_shape[0] * (in_shape[1] + 2)) + "], " + self.type + " output_AveragePooling[" + str(out_shape[0] * out_shape[1]) + "]);\n"
                            self.full_source_CNN_cc.append(["\taverage_Pool2D_" + str(self.index_P2D) + "(",self.config["layers"][i]['config']['name'], "", ""])
                            self.full_source_Pool_cc.append(source_Pool_cc)
                            self.full_source_Pool_hh.append(source_Pool_hh)
                        else :
                            if self.config["layers"][i]['config']['padding'] == 'same':
                                pad = find_smallest_pad(in_shape[1], poolSize, strides)
                                self.call_function += "\t" + self.type + " " + "OutPadPool" + str(self.index_P2D) + "[" + str(int(in_shape[0] * (in_shape[1] + 2 * pad) * (in_shape[1] + 2 * pad))) + "];\n"
                                self.call_function += "\t" + self.type + " " + self.config["layers"][i]['config']['name'] + "[" + str(out_shape[0] * out_shape[1] * out_shape[2]) + "];\n"
                                source_pad_pool_cc = "void Padding_Pool2D_" + str(self.index_P2D) + "(" + self.type + " input_Pad_Pool[" + str(in_shape[0] * in_shape[1] * in_shape[2]) + "], " + self.type + " output_Pad_Pool[" + str(int(in_shape[0] * (in_shape[1] + 2 * pad) * (in_shape[2] + 2 * pad))) + "]){\n\tloop_for_3_channel_pad_" + str(self.index_P2D) + ":\n\tfor (int c = 0; c < " + str(in_shape[0]) + "; c++){" + "\n\t\tloop_for_channel_pad_" + str(self.index_P2D) + ":\n\t\tfor (int n = 0; n < " + str(int(in_shape[1] + 2 * pad)) + "; n++){\n\t\t\tloop_for_weight_pad_" + str(self.index_P2D) + ":\n\t\t\tfor (int i = 0; i < " + str(int(in_shape[2] + 2 * pad)) + "; i++){\n\t\t\t\t"

                                if pad < 1:
                                    if pad == 0 :
                                        source_pad_pool_cc += "output_Pad_Pool[" + str(int(in_shape[2] + 2 * pad)) + " * " + str(int(in_shape[1] + 2 * pad)) + " * c + " + str(int(in_shape[1] + 2 * pad)) + " * n + i] = input_Pad_Pool[" + str(int(in_shape[2])) + " * " + str(int(in_shape[1])) + " * c + " + str(int(in_shape[1])) + " * n + i];\n\t\t\t}\n\t\t}\n\t}\n}\n"
                                    else:
                                        source_pad_pool_cc += "if (n >= " + str(int(in_shape[1])) + ") output_Pad_Pool[" + str(int(in_shape[2] + 2 * pad)) + " * " + str(int(in_shape[1] + 2 * pad)) + " * c + " + str(int(in_shape[1] + 2 * pad)) + " * n + i] = 0; else if (i >= " + str(int(in_shape[2])) + ") output_Pad_Pool[" + str(int(in_shape[2] + 2 * pad)) + " * " + str(int(in_shape[1] + 2 * pad)) + " * c + " + str(int(in_shape[1] + 2 * pad)) + " * n + i] = 0; else output_Pad_Pool[" + str(int(in_shape[2] + 2 * pad)) + " * " + str(int(in_shape[1] + 2 * pad)) + " * c + " + str(int(in_shape[1] + 2 * pad)) + " * n + i] = input_Pad_Pool["  + str(int(in_shape[2])) + " * " + str(int(in_shape[1])) + " * c + " + str(int(in_shape[1])) + " * n + i];\n\t\t\t}\n\t\t}\n\t}\n}\n"
                                else:
                                    source_pad_pool_cc += "if (n < " + str(pad) + " || n >= " + str(in_shape[1] + pad) + ") output_Pad_Pool[" + str(in_shape[2] + 2 * pad) + " * " + str(in_shape[1] + 2 * pad) + " * c + " + str(in_shape[1] + 2 * pad) + " * n + i] = 0; else if (i < " + str(pad) + " || i >= " + str(in_shape[2] + pad) + ") output_Pad_Pool[" + str(in_shape[2] + 2 * pad) + " * " + str(in_shape[1] + 2 * pad) + " * c + " + str(in_shape[1] + 2 * pad) + " * n + i] = 0; else output_Pad_Pool[" + str(in_shape[2] + 2 * pad) + " * " + str(in_shape[1] + 2 * pad) + " * c + " + str(in_shape[1] + 2 * pad) + " * n + i] = input_Pad_Pool["  + str(in_shape[2]) + " * " + str(in_shape[1]) + " * c + " + str(in_shape[1]) + " * n + i - " + str(2 * pad) + "];\n\t\t\t}\n\t\t}\n\t}\n}\n"

                                source_pad_pool_hh = "void Padding_Pool2D_" + str(self.index_P2D) + "(" + self.type + " input_Pad_Pool[" + str(in_shape[0] * in_shape[1] * in_shape[2]) + "], " + self.type + " output_Pad_Pool[" + str(int(in_shape[0] * (in_shape[1] + 2 * pad) * (in_shape[2] + 2 * pad))) + "]);\n"
                                source_Pool_cc = self.fxp_inc + "void average_Pool2D_" + str(self.index_P2D) + "(" + self.type + " input_AveragePooling[" + str(int(in_shape[0] * (in_shape[1] + 2 * pad) * (in_shape[2] + 2 * pad))) + "], " + self.type + " output_AveragePooling[" + str(out_shape[0] * out_shape[1] * out_shape[2]) + "]){\n\tint PoolSize = " + str(poolSize) + ";\n\tint stride = " + str(strides) + ";\n\tint index = 0;\n\tfor (int i = 0; i < " + str(out_shape[0]) + "; i++){\n\t\tindex = 0;\n\t\tfor (int z = 0; z < " + str(out_shape[1]) + "; z++){\n\t\t\tfor (int y = 0; y < " + str(out_shape[2]) + "; y++){\n\t\t\t\t" + str(self.type) + " Average = 0;\n\t\t\t\t" + str(self.type) + " Pool_value = 0;\n\t\t\t\tfor (int h = 0; h < PoolSize; h++){\n\t\t\t\t\tfor (int w = 0; w < PoolSize; w++){\n\t\t\t\t\t\tint Pool_index = " + str(int(in_shape[1] + 2 * pad)) + " * " + str(int(in_shape[2] + 2 * pad)) + " * i + " + str(int(in_shape[1] + 2 * pad)) + " * h + " + str(int(in_shape[2] + 2 * pad)) + " * stride * z + w + y * stride;\n\t\t\t\t\t\tPool_value += input_AveragePooling[Pool_index];" + "\n\t\t\t\t\t\tAverage = Pool_value / " + str(poolSize * poolSize) + ";\n\t\t\t\t\t}\n\t\t\t\t}" + "\n\t\t\t\tint outIndex = " + str(out_shape[1]) + " * " + str(out_shape[2]) + " * i + index;\n\t\t\t\toutput_AveragePooling[outIndex] = Average;\n\t\t\t\tindex++;" + "\n\t\t\t}\n\t\t}\n\t}\n}\n"
                                source_Pool_hh = self.fxp_inc + "void average_Pool2D_" + str(self.index_P2D) + "(" + self.type + " input_AveragePooling[" + str(int(in_shape[0] * (in_shape[1] + 2 * pad) * (in_shape[2] + 2 * pad))) + "], " + self.type + " output_AveragePooling[" + str(out_shape[0] * out_shape[1] * out_shape[2]) + "]);\n"

                                self.full_source_CNN_cc.append(["\tPadding_Pool2D_" + str(self.index_P2D) + "(", "OutPadPool" + str(self.index_P2D), "", ""])
                                self.full_source_CNN_cc.append(["\taverage_Pool2D_" + str(self.index_P2D) + "(",self.config["layers"][i]['config']['name'], "", ""])
                                self.full_source_Pool_cc.append(source_Pool_cc)
                                self.full_source_Pool_hh.append(source_Pool_hh)
                                ...
                                source_Pool_hh = self.fxp_inc + "void average_Pool2D_" + str(
                                    self.index_P2D) + "(" + self.type + " input_AveragePooling[" + str(in_shape[0] * (
                                            in_shape[1] + 2)) + "], " + self.type + " output_AveragePooling[" + str(
                ...
                if layer.find("max_pooling2d") >= 0:
                    if layer.find("global_max_pooling2d") < 0:
                        found = 1
                        in_shape = (self.model.layers[i].input.shape[1], self.model.layers[i].input.shape[2], self.model.layers[i].input.shape[3])
                        out_shape = (self.model.layers[i].output.shape[1], self.model.layers[i].output.shape[2], self.model.layers[i].output.shape[3])
                        strides = self.model.layers[i].strides[0]
                        ...
                        if isinstance(padding, int):
                            ...
                            source_Pool_hh = self.fxp_inc + "void Max_Pool2D_" + str(
                                ...
                                out_shape[0] * out_shape[1]) + "]);\n"
                            self.full_source_CNN_cc.append(["\tMax_Pool2D_" + str(self.index_P2D) + "(",self.config["layers"][i]['config']['name'], "", ""])
                            self.full_source_Pool_cc.append(source_Pool_cc)
                            self.full_source_Pool_hh.append(source_Pool_hh)
                        else :
                            if self.config["layers"][i]['config']['padding'] == 'same':
                                ...
                                source_pad_pool_hh = "void Padding_Pool2D_" + str(self.index_P2D) + "(" + self.type + " input_Pad_Pool[" + str(in_shape[0] * in_shape[1] * in_shape[2]) + "], " + self.type + " output_Pad_Pool[" + str(int(in_shape[0] * (in_shape[1] + 2 * pad) * (in_shape[2] + 2 * pad))) + "]);\n"
                                source_Pool_cc = self.fxp_inc + "void Max_Pool2D_" + str(self.index_P2D) + "(" + self.type + " input_MaxPooling[" + str(int(in_shape[0] * (in_shape[1] + 2 * pad) * (in_shape[2] + 2 * pad))) + "], " + self.type + " output_MaxPooling[" + str(out_shape[0] * out_shape[1] * out_shape[2]) + "]){\n\tint PoolSize = " + str(poolSize) + ";\n\tint stride = " + str(strides) + ";\n\tint index = 0;\n\tfor (int i = 0; i < " + str(out_shape[0]) + "; i++){\n\t\tindex = 0;\n\t\tfor (int z = 0; z < " + str(out_shape[1]) + "; z++){\n\t\t\tfor (int y = 0; y < " + str(out_shape[2]) + "; y++){\n\t\t\t\t" + self.type + " max_c = -10;\n\t\t\t\tfor (int h = 0; h < PoolSize; h++){\n\t\t\t\t\tfor (int w = 0; w < PoolSize; w++){\n\t\t\t\t\t\tint Pool_index = " + str(int(in_shape[1] + 2 * pad)) + " * " + str(int(in_shape[2] + 2 * pad)) + " * i + " + str(int(in_shape[1] + 2 * pad)) + " * h + " + str(int(in_shape[2] + 2 * pad)) + " * stride * z + w + y * stride;\n\t\t\t\t\t\t" + self.type + " Pool_value = input_MaxPooling[Pool_index];" + "\n\t\t\t\t\t\tif (Pool_value >= max_c) max_c = Pool_value;" + "\n\t\t\t\t\t}\n\t\t\t\t}" + "\n\t\t\t\tint outIndex = " + str(out_shape[1]) + " * " + str(out_shape[2]) + " * i + index;\n\t\t\t\toutput_MaxPooling[outIndex] = max_c;\n\t\t\t\tindex++;" + "\n\t\t\t}\n\t\t}\n\t}\n}\n"
                                source_Pool_hh = self.fxp_inc + "void Max_Pool2D_" + str(self.index_P2D) + "(" + self.type + " input_MaxPooling[" + str(int(in_shape[0] * (in_shape[1] + 2 * pad) * (in_shape[2] + 2 * pad))) + "], " + self.type + " output_MaxPooling[" + str(out_shape[0] * out_shape[1] * out_shape[2]) + "]);\n"
                                ...
                                self.call_function += "\t" + self.type + " " + self.config["layers"][i]['config']['name'] + "[" + str(out_shape[0] * out_shape[1] * out_shape[2]) + "];\n"
                                source_Pool_cc = self.fxp_inc + "void Max_Pool2D_" + str(self.index_P2D) + "(" + self.type + " input_MaxPooling[" + str(in_shape[0] * in_shape[1] * in_shape[2]) + "], " + self.type + " output_MaxPooling[" + str(out_shape[0] * out_shape[1] * out_shape[2]) + "]){\n\tint PoolSize = " + str(poolSize) + ";\n\tint stride = " + str(strides) + ";\n\tint index = 0;\n\tfor (int i = 0; i < " + str(out_shape[0]) + "; i++){\n\t\tindex = 0;\n\t\tfor (int z = 0; z < " + str(out_shape[1]) + "; z++){\n\t\t\tfor (int y = 0; y < " + str(out_shape[2]) + "; y++){\n\t\t\t\t" + self.type + " max_c = -10;\n\t\t\t\tfor (int h = 0; h < PoolSize; h++){\n\t\t\t\t\tfor (int w = 0; w < PoolSize; w++){\n\t\t\t\t\t\tint Pool_index = " + str(in_shape[1]) + " * " + str(in_shape[2]) + " * i + " + str(in_shape[1]) + " * h + " + str(in_shape[2]) + " * stride * z + w + y * stride;\n\t\t\t\t\t\t" + self.type + " Pool_value = input_MaxPooling[Pool_index];" + "\n\t\t\t\t\t\tif (Pool_value >= max_c) max_c = Pool_value;" + "\n\t\t\t\t\t}\n\t\t\t\t}" + "\n\t\t\t\tint outIndex = " + str(out_shape[1]) + " * " + str(out_shape[2]) + " * i + index;\n\t\t\t\toutput_MaxPooling[outIndex] = max_c;\n\t\t\t\tindex++;" + "\n\t\t\t}\n\t\t}\n\t}\n}\n"
                                source_Pool_hh = self.fxp_inc + "void Max_Pool2D_" + str(self.index_P2D) + "(" + self.type + " input_MaxPooling[" + str(in_shape[0] * (in_shape[1] + 2)) + "], " + self.type + " output_MaxPooling[" + str(out_shape[0] * out_shape[1]) + "]);\n"
                                self.full_source_CNN_cc.append(["\tMax_Pool2D_" + str(self.index_P2D) + "(",self.config["layers"][i]['config']['name'], "", ""])
                                self.full_source_Pool_cc.append(source_Pool_cc)
                                self.full_source_Pool_hh.append(source_Pool_hh)
                ...
                if layer.find("max_pooling1d") >= 0:
                    if layer.find("global_max_pooling1d") < 0:
                        ...
                        if self.config["layers"][i]['config']['padding'] == 'same':
                            ...
                            in_shape_if_padding = (in_shape[0], (in_shape[1] + 2 * padding))
                            # test = math.floor(padding)
                            if padding - math.floor(padding) != 0.5:
                                source_pad_pool_cc = self.fxp_inc + "void Padding_Pool_" + str(self.index_P) + "(" + self.type + " input_Pad_Pool[" + str(in_shape[0] * in_shape[1]) + "], " + self.type + " output_Pad_Pool[" + str(int(in_shape_if_padding[0] * in_shape_if_padding[1])) + "]){\n\tloop_for_3_channel_pad_" + str(self.index_P) + ":\n\tfor (int c = 0; c < " + str(int(in_shape_if_padding[0])) + "; c++){" + "\n\t\tloop_for_channel_pad_" + str(self.index_P) + ":\n\t\tfor (int n = 0; n < " + str(int(in_shape_if_padding[1])) + "; n++){\n\t\t\tif (n < " + str(int(0 + padding)) + " || n >= " + str(int(in_shape[1] + padding)) + ") output_Pad_Pool[" + str(int(in_shape_if_padding[1])) + " * c + n]=0; else output_Pad_Pool[" + str(int(in_shape_if_padding[1])) + " * c + n] = input_Pad_Pool[" + str(in_shape[1]) + " * c + n - " + str(int(padding)) + "];\n\t\t}\n\t}\n}\n"
                                source_pad_pool_hh = self.fxp_inc + "void Padding_Pool_" + str(self.index_P) + "(" + self.type + " input_Pad_Pool[" + str(in_shape[0] * in_shape[1]) + "], " + self.type + " output_Pad_Pool[" + str(int(in_shape_if_padding[0] * in_shape_if_padding[1])) + "]);\n"
                                self.full_source_Pool_cc.append(source_pad_pool_cc)
                                self.full_source_Pool_hh.append(source_pad_pool_hh)
                                self.call_function += "\t" + self.type + " OutPadPool" + str(self.index_P) + "[" + str(int(in_shape_if_padding[0] * in_shape_if_padding[1])) + "];\n"
                                self.full_source_CNN_cc.append(["\tPadding_Pool_" + str(self.index_P) + "(", "OutPadPool" + str(self.index_P), "",
                                         ""])
                            else:
                                source_pad_pool_cc = self.fxp_inc + "void Padding_Pool_" + str(self.index_P) + "(" + self.type + " input_Pad_Pool[" + str(in_shape[0] * in_shape[1]) + "], " + self.type + " output_Pad_Pool[" + str(int(in_shape_if_padding[0] * in_shape_if_padding[1])) + "]){\n\tloop_for_3_channel_pad_" + str(self.index_P) + ":\n\tfor (int c = 0; c < " + str(int(in_shape_if_padding[0])) + "; c++){" + "\n\t\tloop_for_channel_pad_" + str(self.index_P) + ":\n\t\tfor (int n = 0; n < " + str(int(in_shape_if_padding[1])) + "; n++){\n\t\t\tif (n >= " + str(int(in_shape[1] + 2 * padding)) + ") output_Pad_Pool[" + str(int(in_shape_if_padding[1])) + " * c + n]=0; else output_Pad_Pool[" + str(int(in_shape_if_padding[1])) + " * c + n] = input_Pad_Pool[" + str(in_shape[1]) + " * c + n];\n\t\t}\n\t}\n}\n"
                                source_pad_pool_hh = self.fxp_inc + "void Padding_Pool_" + str(self.index_P) + "(" + self.type + " input_Pad_Pool[" + str(in_shape[0] * in_shape[1]) + "], " + self.type + " output_Pad_Pool[" + str(int(in_shape_if_padding[0] * in_shape_if_padding[1])) + "]);\n"
                                self.full_source_Pool_cc.append(source_pad_pool_cc)
                                self.full_source_Pool_hh.append(source_pad_pool_hh)
                                self.call_function += "\t" + self.type + " OutPadPool" + str(self.index_P) + "[" + str(int(in_shape_if_padding[0] * in_shape_if_padding[1])) + "];\n"
                            ...
                            source_Pool_hh = self.fxp_inc + "void Max_Pool1D_" + str(
                                ...
                                int(in_shape_if_padding[0] * in_shape_if_padding[1])) + "], " + self.type + " output_MaxPooling[" + str(
                                out_shape[0] * out_shape[1]) + "]);\n"
                            self.full_source_Pool_cc.append(source_Pool_cc)
                            self.full_source_Pool_hh.append(source_Pool_hh)
                ...
                if layer.find("global_max_pooling2d") >= 0:
                    if len(self.model.layers[i].input.shape) == 4:
                        ...
                        source_Flatten_hh = "void GlobalMaxPool2D(" + self.type + " input_GlobalMaxPool2D[" + str(in_shape[0] *in_shape[1] * in_shape[2]) + "]," + self.type + " output_GlobalMaxPool2D[" + str(out_shape) + "]);\n"
                        source_Flatten_cc = "void GlobalMaxPool2D(" + self.type + " input_GlobalMaxPool2D[" + str(in_shape[0] *in_shape[1] * in_shape[2]) + "]," + self.type + " output_GlobalMaxPool2D[" + str(out_shape) + "]){\n\tint hs = 0;\n\tfor (int i = 0; i < " + str(in_shape[0]) + "; i++){\n\t\t" + self.type + " max = -10;\n\t\tfor (int j = 0; j < " + str(in_shape[1]) + "; j++){\n\t\t\tfor (int k = 0; k < " + str(in_shape[2]) + "; k++){\n\t\t\t\tif (input_GlobalMaxPool2D[" + str(in_shape[1]) + " * " + str(in_shape[2]) + " * i + " + str(in_shape[2]) + " * j + k] >= max) max = input_GlobalMaxPool2D[" + str(in_shape[1]) + " * " + str(in_shape[2]) + " * i + " + str(in_shape[2]) + " * j + k];\n\t\t\t}\n\t\t}\n\t\toutput_GlobalMaxPool2D[hs] = max;\n\t\ths++;\n\t}\n}\n"
                        self.full_source_Pool_cc.append(source_Flatten_cc)
                        self.full_source_Pool_hh.append(source_Flatten_hh)
                        self.call_function += "\t" + self.type + " " + self.config["layers"][i]['config']['name'] + "[" + str(out_shape) + "];\n"
                        self.full_source_CNN_cc.append(["\tGlobalMaxPool2D(", self.config["layers"][i]['config']['name'], "", ""])
                ...
                if layer.find("global_average_pooling2d") >= 0:
                    if len(self.model.layers[i].input.shape) == 4:
                        ...
                        out_shape = (self.model.layers[i].output.shape[1])
                        # source_Flatten_cc = "void"
                        source_Flatten_hh = "void GlobalAveragePool2D(" + self.type + " input_GlobalAveragePool2D[" + str(in_shape[0] *in_shape[1] * in_shape[2]) + "]," + self.type + " output_GlobalAveragePool2D[" + str(out_shape) + "]);\n"
                        source_Flatten_cc = "void GlobalAveragePool2D(" + self.type + " input_GlobalAveragePool2D[" + str(in_shape[0] *in_shape[1] * in_shape[2]) + "]," + self.type + " output_GlobalAveragePool2D[" + str(out_shape) + "]){\n\tint hs = 0;\n\tfor (int i = 0; i < " + str(in_shape[0]) + "; i++){\n\t\t" + self.type + " avg = 0;\n\t\tfor (int j = 0; j < " + str(in_shape[1]) + "; j++){\n\t\t\tfor (int k = 0; k < " + str(in_shape[2]) + "; k++){\n\t\t\t\tavg += input_GlobalAveragePool2D[" + str(in_shape[1]) + " * " + str(in_shape[2]) + " * i + " + str(in_shape[2]) + " * j + k];\n\t\t\t}\n\t\t}\n\t\toutput_GlobalAveragePool2D[hs] = avg / (" + str(in_shape[1]) + " * " + str(in_shape[2]) + ") ;\n\t\ths++;\n\t}\n}\n"
                        self.full_source_Pool_cc.append(source_Flatten_cc)
                        self.full_source_Pool_hh.append(source_Flatten_hh)
                        self.call_function += "\t" + self.type + " " + self.config["layers"][i]['config']['name'] + "[" + str(out_shape) + "];\n"
                        self.full_source_CNN_cc.append(["\tGlobalAveragePool2D(", self.config["layers"][i]['config']['name'], "", ""])
                ...
                if layer.find("global_max_pooling1d") >= 0:
                    if len(self.model.layers[i].input.shape) == 3:
                        ...
                        out_shape = (self.model.layers[i].output.shape[1])
                        # source_Flatten_cc = "void"
                        source_Flatten_hh = "void GlobalMaxPool1D(" + self.type + " input_GlobalMaxPool1D[" + str(in_shape[0] *in_shape[1]) + "]," + self.type + " output_GlobalMaxPool1D[" + str(out_shape) + "]);\n"
                        source_Flatten_cc = "void GlobalMaxPool1D(" + self.type + " input_GlobalMaxPool1D[" + str(in_shape[0] *in_shape[1]) + "]," + self.type + " output_GlobalMaxPool1D[" + str(out_shape) + "]){\n\tint hs = 0;\n\tfor (int i = 0; i < " + str(in_shape[1]) + "; i++){\n\t\t" + self.type + " max = -10;\n\t\tfor (int j = 0; j < " + str(in_shape[0]) + "; j++){\n\t\t\tif (input_GlobalMaxPool1D[" + str(in_shape[0]) + " * i + j] >= max) max = input_GlobalMaxPool1D[" + str(in_shape[0]) + " * i + j];\n\t\t}\n\t\toutput_GlobalMaxPool1D[hs] = max ;\n\t\ths++;\n\t}\n}\n"
                        self.full_source_Pool_cc.append(source_Flatten_cc)
                        self.full_source_Pool_hh.append(source_Flatten_hh)
                        self.call_function += "\t" + self.type + " " + self.config["layers"][i]['config']['name'] + "[" + str(out_shape) + "];\n"
                        self.full_source_CNN_cc.append(["\tGlobalMaxPool1D(", self.config["layers"][i]['config']['name'] , "", ""])
                ...
                if layer.find("global_average_pooling1d") >= 0:
                    if len(self.model.layers[i].input.shape) == 3:
                        ...
                        out_shape = (self.model.layers[i].output.shape[1])
                        # source_Flatten_cc = "void"
                        source_Flatten_hh = "void GlobalAveragePool1D(" + self.type + " input_GlobalAveragePool1D[" + str(in_shape[0] *in_shape[1]) + "]," + self.type + " output_GlobalAveragePool1D[" + str(out_shape) + "]);\n"
                        source_Flatten_cc = "void GlobalAveragePool1D(" + self.type + " input_GlobalAveragePool1D[" + str(in_shape[0] *in_shape[1]) + "]," + self.type + " output_GlobalAveragePool1D[" + str(out_shape) + "]){\n\tint hs = 0;\n\tfor (int i = 0; i < " + str(in_shape[1]) + "; i++){\n\t\t" + self.type + " avg = 0;\n\t\tfor (int j = 0; j < " + str(in_shape[0]) + "; j++){\n\t\t\tavg += input_GlobalAveragePool1D[" + str(in_shape[0]) + " * i + j] / " + str(in_shape[0]) + ";\n\t\t}\n\t\toutput_GlobalAveragePool1D[hs] = avg;\n\t\ths++;\n\t}\n}\n"
                        self.full_source_Pool_cc.append(source_Flatten_cc)
                        self.full_source_Pool_hh.append(source_Flatten_hh)
                        self.call_function += "\t" + self.type + " " + self.config["layers"][i]['config']['name'] + "[" + str(out_shape) + "];\n"
                        self.full_source_CNN_cc.append(["\tGlobalAveragePool1D(", self.config["layers"][i]['config']['name'] , "", ""])
                ...
                if layer.find("flatten") >= 0:
                    ...
                    if len(self.model.layers[i].input.shape) == 3:
                        in_shape = (self.model.layers[i].input.shape[2], self.model.layers[i].input.shape[1])
                        out_shape = self.model.layers[i].output.shape[1]
                        source_Flatten_cc = "void flatten_0(" + self.type + " input_Flatten[" + str(in_shape[0] * in_shape[1]) + "]," + self.type + " output_Flatten[" + str(out_shape) + "]){\n\tint hs = 0;\n\tloop_for_a_flatten:\n\tfor (int i = 0; i < " + str(in_shape[0]) + "; i++){\n\t\tloop_for_c_flatten:\n\t\tfor (int j = 0; j < " + str(in_shape[1]) + "; j++){\n\t\t\toutput_Flatten[hs] = input_Flatten[" + str(in_shape[1]) + "*j+i];\n\t\t\ths++;\n\t\t}\n\t}\n}\n"
                        source_Flatten_hh = "void flatten_0(" + self.type + " input_Flatten[" + str(in_shape[0] *in_shape[1]) + "]," + self.type + " output_Flatten[" + str(out_shape) + "]);\n"
                        self.full_source_Pool_cc.append(source_Flatten_cc)
                        self.full_source_Pool_hh.append(source_Flatten_hh)
                        self.call_function += "\t" + self.type + " " + self.config["layers"][i]['config']['name'] + "[" + str(out_shape) + "];\n"
                        self.full_source_CNN_cc.append(["\tflatten_0(", self.config["layers"][i]['config']['name'] , "", ""])
                    # Flatten for 3d
                    if len(self.model.layers[i].input.shape) == 4:
                        in_shape = (self.model.layers[i].input.shape[1], self.model.layers[i].input.shape[2],
                                    self.model.layers[i].input.shape[3])
                        ...
                        source_Flatten_cc = "void flatten_0(" + self.type + " input_Flatten[" + str(
                            ...
                            in_shape[1]) + " * k + j ];\n\t\t\t\ths++;\n\t\t\t}\n\t\t}\n\t}\n}\n"
                        source_Flatten_hh = "void flatten_0(" + self.type + " input_Flatten[" + str(
                            in_shape[0] * in_shape[1] * in_shape[2]) + "]," + self.type + " output_Flatten[" + str(
                            out_shape) + "]);\n"
                        self.full_source_Pool_cc.append(source_Flatten_cc)
                        self.full_source_Pool_hh.append(source_Flatten_hh)
                ...
                if layer.find("dense") >= 0:
                    ...
                    if activation == "sigmoid":
                        result_acc = "\tfor (int i = 0; i < " + str(out_shape) + "; i++){\n\t\tout_Dense[i]=1/(1 + exp(-out_Dense[i]));\n\t}\n"
                        include = "#include <cmath>\n"
                    elif activation == "relu":
                        result_acc = "\tfor (int i = 0; i < " + str(out_shape) + "; i++){\n\t\tif (out_Dense[i] < 0) out_Dense[i] = 0; else out_Dense[i] = out_Dense[i];\n\t}\n"
                        include = ""
                    ...
                    source_Dense_cc = self.fxp_inc + include + "void Dense_" + str(self.index_D) + "(" + self.type + " input_Dense[" + str(in_shape) + "]," + out_dense + "," + self.type + " bias[" + str(out_shape) + "]," + self.type + " weight[" + str(in_shape * out_shape) + "]){\n\t" + self.type + " out_Dense[" + str(out_shape) + "];\n" + "\tloop_for_a_Dense_" + str(self.index_D) + ":\n\tfor (int i = 0; i < " + str(out_shape) + "; i++){\n\t\t" + self.type + " s=0;\n\t\tloop_for_b_Dense_" + str(self.index_D) + ":\n\t\tfor (int j = 0; j < " + str(in_shape) + "; j++){\n\t\t\ts+=input_Dense[j]*weight[j*" + str(out_shape) + "+i];\n\t\t}\n\t\t" + "out_Dense[i]=s+bias[i];" + "\n\t}\n" + result_acc + end +"}\n"
            ...
            def find_input(Layer_name, index):
                if "Pad" in Layer_name:
                    ...
                    subname = Layer_name
                if Layer_name == 'OutModel':
                    subname = self.config["layers"][len(self.config["layers"]) - 1]['config']['name']
                for i in range(len(self.config["layers"])):
                    if self.config["layers"][i]['config']['name'] == subname:
                        if ("conv" in subname and "Pad" in self.full_source_CNN_cc[index-1][1]) or ("pool" in subname and "Pad" in self.full_source_CNN_cc[index-1][1]):
                ...
                if i == 0:
                    ...
                    if (len(self.full_source_CNN_cc[i]) > 2):
                        if self.full_source_CNN_cc[i][2] == "":
                            self.call_function += self.full_source_CNN_cc[i][0] + find_input(self.full_source_CNN_cc[i][1],i) + "," + \
                                                  self.full_source_CNN_cc[i][1] + ");\n"
                        else:
                            if (len(self.full_source_CNN_cc[i]) == 6):
                                self.call_function += self.full_source_CNN_cc[i][0] + find_input(self.full_source_CNN_cc[i][1],i) + "," + self.full_source_CNN_cc[i][1] + "," + self.full_source_CNN_cc[i][2] + "," + self.full_source_CNN_cc[i][3] + "," + self.full_source_CNN_cc[i][4] + "," + self.full_source_CNN_cc[i][5] + ");\n"
                            if (len(self.full_source_CNN_cc[i]) == 5):
                                self.call_function += self.full_source_CNN_cc[i][0] + find_input(self.full_source_CNN_cc[i][1],i) + "," + self.full_source_CNN_cc[i][1] + "," + self.full_source_CNN_cc[i][2] + "," + self.full_source_CNN_cc[i][3] + "," + self.full_source_CNN_cc[i][4] + ");\n"
                        ...
                        if "add" in self.full_source_CNN_cc[i][1]:
                            ...
                            self.call_function += self.full_source_CNN_cc[i][0] + find_input_for_add(self.full_source_CNN_cc[i][1],i) + self.full_source_CNN_cc[i][1] + ");\n"
                            ...
                            self.call_function += self.full_source_CNN_cc[i][0] + find_input(self.full_source_CNN_cc[i][1],i) + "," + self.full_source_CNN_cc[i][1] + ");\n"


            if len(self.model.layers[1].input.shape) == 4:
                self.source_CNN += "void CNN(" + self.type + " InModel[" + str(self.model.layers[1].input.shape[2] * self.model.layers[1].input.shape[1] *self.model.layers[1].input.shape[3]) + "]," + self.type + self.out[0] + "," + self.type + " Weights[" + str(self.cnt_param) + "]){\n" + self.call_function + "}\n"
            ...
            if len(self.model.layers[1].input.shape) == 3:
                self.source_CNN += "void CNN(" + self.type + " InModel[" + str(self.model.layers[1].input.shape[2] * self.model.layers[1].input.shape[1]) + "]," + self.type + self.out[0] + "," + self.type + " Weights[" + str(self.cnt_param) + "]){\n" + self.call_function + "}\n"
                self.source_CNN_hh = "void CNN(" + self.type + " InModel[" + str(
                    self.model.layers[1].input.shape[2] *
                    self.model.layers[1].input.shape[1]) + "]," + self.type + self.out[0] + "," + self.type + " Weights[" + str(
                    self.cnt_param) + "]);\n"
            if len(self.model.layers[1].input.shape) == 2:
                self.source_CNN += "void CNN(" + self.type + " InModel[" + str(self.model.layers[1].input.shape[1]) + "]," + self.type + self.out[0] + "," + self.type + " Weights[" + str(self.cnt_param) + "]){\n" + self.call_function + "}\n"
                self.source_CNN_hh = "void CNN(" + self.type + " InModel[" + str(self.model.layers[1].input.shape[1]) + "]," + self.type + self.out[0] + "," + self.type + " Weights[" + str(self.cnt_param) + "]);\n"

            if self.choose_only_output == False :
                add_because_of_onlyoutput = [" * " + self.out[1], "for (int j = 0; j < " + self.out[1] +"; j++){\n\t\t\t*(OutArray + " + self.out[1] + " * i + j) = OutModel[j];\n\t\t}"]
            else:
            ...
            if self.ide == "vs":
                ...
                ignore_warning = ""
            if (len(self.model.layers[1].input.shape) == 4):
                self.source_CNN_tb = ignore_warning + "#include <conio.h>\n#include <stdio.h>\n#include <stdlib.h>\n#include <math.h>\n#include <string>\n#include <fstream>\n#include <iostream>\n#include \"CNN.h\"\n#include \"Conv.h\"\n#include \"Pool.h\"\n#include \"Dense.h\"\n#define NumberOfPicture " + "...\n#define d " + "...\n" + self.fxp_inc + "int main(){\n\t" + self.type + " " + self.out[0].split("&")[-1] + ";\n\t" + self.type + "* Weights = (" + self.type + "*)malloc(" + str(self.cnt_param) + " * sizeof(" + self.type + "));\n\tfloat tmp;\n\tFILE* Weight = fopen(\"Float_Weights.txt\", \"r\");\n\tfor (int i = 0; i < " + str(self.cnt_param) + "; i++){\n\t\tfscanf(Weight, \"%f\", &tmp);\n\t\t*(Weights + i)=tmp;\n\t}\n\tfclose(Weight);" + "\n\t////read Input" + "\n\t" + self.type + "* InModel = (" + self.type + "*)malloc((NumberOfPicture * d * " + str(self.model.layers[1].input.shape[2]) + " * " + str(self.model.layers[1].input.shape[3]) + ") * sizeof(" + self.type + "));\n\tFILE* Input = fopen(\"X.txt\", \"r\");\n\tfor (int i = 0; i < " + "NumberOfPicture * d * " + str(self.model.layers[1].input.shape[2]) + " * " + str(self.model.layers[1].input.shape[3]) + "; i++){\n\t\tfscanf(Input, \"%f\", &tmp);\n\t\t*(InModel + i)=tmp;\n\t}\n\tfclose(Input);" + "\n\t//Read Label"  + "\n\t" + self.type + "*Label = (" + self.type + "*)malloc((NumberOfPicture" + add_because_of_onlyoutput[0] + ") * sizeof(" + self.type + "));" + "\n\tFILE* Output = fopen(\"Y.txt\", \"r\");\n\tfor (int i = 0; i < NumberOfPicture" + add_because_of_onlyoutput[0] + " ; i++)\n\t{\n\t\tfscanf(Output, \"%f\", &tmp);\n\t\t*(Label + i) = tmp;\n\t}\n\tfclose(Output);\n\t" + self.type + "*OutArray = (" + self.type +"*)malloc((NumberOfPicture" + add_because_of_onlyoutput[0] + ") * sizeof(" + self.type + "));\n\t" + self.type + " Image[d * " + str(self.model.layers[1].input.shape[2]) + " * " + str(self.model.layers[1].input.shape[3]) + "] = {};\n\tfor (int i = 0; i < NumberOfPicture ; i++)\n\t{\n\t\tint startIndex = i * d * " + str(self.model.layers[1].input.shape[2]) + " * " + str(self.model.layers[1].input.shape[3]) + ";\n\t\tfor (int k = 0; k < d * " + str(self.model.layers[1].input.shape[2]) + " * " + str(self.model.layers[1].input.shape[3]) + "; k++)\n\t\t{\n\t\t\tImage[k] = *(InModel + startIndex + k);\n\t\t}\n\t\tCNN(Image, OutModel, Weights);\n\t\t*(OutArray + i) = OutModel;\n\t}\n\tfloat countTrue = 0;\n\tfor (int i = 0; i < NumberOfPicture" + add_because_of_onlyoutput[0] + "; i++)\n\t{\n\t\tint labelValue = *(Label + i);\n\t\tint PredictValue = *(OutArray + i);\n\t\tif (labelValue == PredictValue)\n\t\t{\n\t\t\tcountTrue = countTrue + 1;\n\t\t}\n\t}\n\tfloat accuracy = (float)((countTrue / (NumberOfPicture" + add_because_of_onlyoutput[0] + ")) * 100);\n\tstd::cout << \"accuracy of Model: \" << accuracy << \"%\\n\";" + "\n\t//std::cout << \"Result: \" <<  OutModel <<  \"\\n\";" + "\n\treturn 0;\n}\n"
            if (len(self.model.layers[1].input.shape) == 3):
                self.source_CNN_tb = ignore_warning + "#include <conio.h>\n#include <stdio.h>\n#include <stdlib.h>\n#include <math.h>\n#include <string>\n#include <fstream>\n#include <iostream>\n#include \"CNN.h\"\n#include \"Conv.h\"\n#include \"Pool.h\"\n#include \"Dense.h\"\n#define NumberOfPicture " + "...\n#define d " + "...\n" + self.fxp_inc + "int main(){\n\t" + self.type + " " + self.out[0].split("&")[-1] + ";\n\t" + self.type + "* Weights = (" + self.type + "*)malloc(" + str(self.cnt_param) + " * sizeof(" + self.type + "));\n\tfloat tmp;\n\tFILE* Weight = fopen(\"Float_Weights.txt\", \"r\");\n\tfor (int i = 0; i < " + str(self.cnt_param) + "; i++){\n\t\tfscanf(Weight, \"%f\", &tmp);\n\t\t*(Weights + i)=tmp;\n\t}\n\tfclose(Weight);" + "\n\t////read Input" + "\n\t" + self.type + "* InModel = (" + self.type + "*)malloc((NumberOfPicture * d * " + str(self.model.layers[1].input.shape[1]) + " * " + str(self.model.layers[1].input.shape[2]) + ") * sizeof(" + self.type + "));\n\tFILE* Input = fopen(\"X.txt\", \"r\");\n\tfor (int i = 0; i < " + "NumberOfPicture * d * " + str(self.model.layers[1].input.shape[1]) + " * " + str(self.model.layers[1].input.shape[2]) + "; i++){\n\t\tfscanf(Input, \"%f\", &tmp);\n\t\t*(InModel + i)=tmp;\n\t}\n\tfclose(Input);" + "\n\t//Read Label"  + "\n\t" + self.type + "*Label = (" + self.type + "*)malloc((NumberOfPicture" + add_because_of_onlyoutput[0] + ") * sizeof(" + self.type + "));" + "\n\tFILE* Output = fopen(\"Y.txt\", \"r\");\n\tfor (int i = 0; i < NumberOfPicture" + add_because_of_onlyoutput[0] + " ; i++)\n\t{\n\t\tfscanf(Output, \"%f\", &tmp);\n\t\t*(Label + i) = tmp;\n\t}\n\tfclose(Output);\n\t" + self.type + "*OutArray = (" + self.type +"*)malloc((NumberOfPicture" + add_because_of_onlyoutput[0] + ") * sizeof(" + self.type + "));\n\t" + self.type + " Image[d * " + str(self.model.layers[1].input.shape[1]) + " * " + str(self.model.layers[1].input.shape[2]) + "] = {};\n\tfor (int i = 0; i < NumberOfPicture ; i++)\n\t{\n\t\tint startIndex = i * d * " + str(self.model.layers[1].input.shape[1]) + " * " + str(self.model.layers[1].input.shape[2]) + ";\n\t\tfor (int k = 0; k < d * " + str(self.model.layers[1].input.shape[1]) + " * " + str(self.model.layers[1].input.shape[2]) + "; k++)\n\t\t{\n\t\t\tImage[k] = *(InModel + startIndex + k);\n\t\t}\n\t\tCNN(Image, OutModel, Weights);\n\t\t" + add_because_of_onlyoutput[1] + "\n\t}\n\tfloat countTrue = 0;\n\tfor (int i = 0; i < NumberOfPicture" + add_because_of_onlyoutput[0] + "; i++)\n\t{\n\t\tint labelValue = *(Label + i);\n\t\tint PredictValue = *(OutArray + i);\n\t\tif (labelValue == PredictValue)\n\t\t{\n\t\t\tcountTrue = countTrue + 1;\n\t\t}\n\t}\n\tfloat accuracy = (float)((countTrue / (NumberOfPicture" + add_because_of_onlyoutput[0] + ")) * 100);\n\tstd::cout << \"accuracy of Model: \" << accuracy << \"%\\n\";" + "\n\t//std::cout << \"Result: \" <<  OutModel <<  \"\\n\";" + "\n\treturn 0;\n}\n"
            if (len(self.model.layers[1].input.shape) < 3):
                self.source_CNN_tb = ignore_warning + "#include <conio.h>\n#include <stdio.h>\n#include <stdlib.h>\n#include <math.h>\n#include <string>\n#include <fstream>\n#include <iostream>\n#include \"CNN.h\"\n#include \"Conv.h\"\n#include \"Pool.h\"\n#include \"Dense.h\"\n#define NumberOfPicture " + "...\n#define d " + "...\n" + self.fxp_inc + "int main(){\n\t" + self.type + " " + self.out[0].split("&")[-1] + ";\n\t" + self.type + "* Weights = (" + self.type + "*)malloc(" + str(self.cnt_param) + " * sizeof(" + self.type + "));\n\tfloat tmp;\n\tFILE* Weight = fopen(\"Float_Weights.txt\", \"r\");\n\tfor (int i = 0; i < " + str(self.cnt_param) + "; i++){\n\t\tfscanf(Weight, \"%f\", &tmp);\n\t\t*(Weights + i)=tmp;\n\t}\n\tfclose(Weight);" + "\n\t////read Input" + "\n\t" + self.type + "* InModel = (" + self.type + "*)malloc((NumberOfPicture * d * " + str(self.model.layers[1].input.shape[1]) + ") * sizeof(" + self.type + "));\n\tFILE* Input = fopen(\"X.txt\", \"r\");\n\tfor (int i = 0; i < " + "NumberOfPicture * d * " + str(self.model.layers[1].input.shape[1]) + "; i++){\n\t\tfscanf(Input, \"%f\", &tmp);\n\t\t*(InModel + i)=tmp;\n\t}\n\tfclose(Input);" + "\n\t//Read Label"  + "\n\t" + self.type + "*Label = (" + self.type + "*)malloc((NumberOfPicture) * sizeof(" + self.type + "));" + "\n\tFILE* Output = fopen(\"Y.txt\", \"r\");\n\tfor (int i = 0; i < NumberOfPicture ; i++)\n\t{\n\t\tfscanf(Output, \"%f\", &tmp);\n\t\t*(Label + i) = tmp;\n\t}\n\tfclose(Output);\n\t" + self.type + " OutArray[NumberOfPicture] = {};\n\t" + self.type + " Image[d * " + str(self.model.layers[1].input.shape[1]) + "] = {};\n\tfor (int i = 0; i < NumberOfPicture ; i++)\n\t{\n\t\tint startIndex = i * d * " + str(self.model.layers[1].input.shape[1]) + ";\n\t\tfor (int k = 0; k < d * " + str(self.model.layers[1].input.shape[1]) + "; k++)\n\t\t{\n\t\t\tImage[k] = *(InModel + startIndex + k);\n\t\t}\n\t\tCNN(Image, OutModel, Weights);\n\t\tOutArray[i] = OutModel;\n\t}\n\tfloat countTrue = 0;\n\tfor (int i = 0; i < NumberOfPicture; i++)\n\t{\n\t\tint labelValue = *(Label + i);\n\t\tif (labelValue == OutArray[i])\n\t\t{\n\t\t\tcountTrue = countTrue + 1;\n\t\t}\n\t}\n\tfloat accuracy = (float)((countTrue / NumberOfPicture) * 100);\n\tstd::cout << \"accuracy of Model: \" << accuracy << \"%\\n\";" + "\n\t//std::cout << \"Result: \" <<  OutModel <<  \"\\n\";" + "\n\treturn 0;\n}\n"
            if self.type == "fxp":
                self.fxp_inc = self.fxp_include
            else:
                self.fxp_inc = ""
    ...
    def Write_Converted_Float_Weights_File(self, path="Converted_Float_Weights.txt"):
        ...
        #
        #
        # def binary32_to_binary18(float_num):
        #     binary32 = float_to_binary32(float_num)
        #
        #     binary18 = binary32[0:18]
        #     binary18 += "00000000000000"
        #     assert len(binary18) == 32, "Input string must be 32 bits long."
        #
        #     # Convert the binary string to an integer
        #     int_rep = int(binary18, 2)
        #
        #     # Pack the integer as a binary and unpack it as a float
        #     float_value = struct.unpack('!f', struct.pack('!I', int_rep))[0]
        #
        #     return float_value

        def float_to_custom_binary(num):
            # Step 1: Get the sign bit
            if num < 0:
                sign_bit = '1'
            ...
            # Step 3: Convert the integer part to binary (15 bits)
            pad = '0' + str(self.fxp_para[0]-self.fxp_para[1]-1) + 'b'
            integer_binary = format(integer_part, pad)  # Convert to binary and pad to 15 bits

            # Step 4: Convert the fractional part to binary (16 bits)
            fractional_binary = ''
            while len(fractional_binary) < self.fxp_para[1]:
                fractional_part *= 2
            ...
            # Pad the fractional binary to make it 16 bits long if necessary
            fractional_binary = fractional_binary.ljust(self.fxp_para[1], '0')

            # Step 5: Combine the sign bit, integer part, and fractional part
            custom_binary = sign_bit + integer_binary + fractional_binary
            return custom_binary

        def custom_binary_to_float(binary_str):
            # Step 1: Extract the sign, integer part, and fractional part
            sign_bit = binary_str[0]
            integer_binary = binary_str[1:11]  # 10 bits for integer part
            fractional_binary = binary_str[11:]  # 7 bits for fractional part

            # Step 2: Convert integer part from binary to decimal
            integer_part = int(integer_binary, 2)

            # Step 3: Convert fractional part from binary to decimal
            fractional_part = 0
        ...
        with open(path, mode='w') as f:
            for i in self.Weights:
                test = float_to_custom_binary(i)
                test_2 = custom_binary_to_float(test)
                f.write(str(test_2) + " ")
        print("Successful Writing Converted Float Weights file!!!")
